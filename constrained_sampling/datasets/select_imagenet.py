...
parser.add_argument('--dir_path', type=str, default='/home/nicolas/dataset/imagenet-root/imagenet/val')
parser.add_argument('--dest_folder', type=str, default='/home/nicolas/Repulsive-score-distillation-RSD-/constrained_sampling/_exp/input/IMAGENET')
...
for item in os.listdir(args.dir_path):
    ...
    if it < 101:
        ...
        with open(f'{dest_folder}/names.txt', 'a') as f:
            f.write(f'{item}.png\n')
