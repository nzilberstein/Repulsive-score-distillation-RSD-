...
dir_path = './data'
data_file = '/home/nzilberstein/red_diff_stable/RED-diff_stable/datacoco/annotations/captions_val2014.json'
...
print(df['caption'].item())
if df['caption'].item() == 'an elephant placing some leaves in its mouth with its trunk':
    print(df['caption'])
