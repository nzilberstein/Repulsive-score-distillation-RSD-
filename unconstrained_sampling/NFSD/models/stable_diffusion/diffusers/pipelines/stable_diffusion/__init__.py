...
try:
    ...
    from .pipeline_stable_diffusion_particle_SDS import StableDiffusionParticleSDSPipeline
    from .pipeline_stable_diffusion_particle_NFSD import StableDiffusionParticleNFSDPipeline
