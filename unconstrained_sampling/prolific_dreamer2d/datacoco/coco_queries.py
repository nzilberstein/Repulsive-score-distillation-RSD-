...
# Create a pandas dataframe and save in each row the queries value
df = pd.DataFrame(queries, columns=['caption'])
df.to_csv('/home/nzilberstein/red_diff_stable/RED-diff_stable/datacoco/subset_object_80.csv', index=False)