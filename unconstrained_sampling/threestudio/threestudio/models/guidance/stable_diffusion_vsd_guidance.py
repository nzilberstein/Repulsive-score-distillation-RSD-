...
class StableDiffusionVSDGuidance(BaseModule):
    ...
    def compute_grad_vsd(
        ...
        if dino_flag is False:
            ...
            # It has already the normalization inside the decoding
            ...
            grad = w * (noise_pred_pretrain - noise_pred_est - gamma * (1 - self.alphas[t]).sqrt().view(-1, 1, 1, 1) * nabla_log.detach())
